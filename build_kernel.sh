...
KERNEL_TOOLS=/home/diamond/prebuilts/kernel-build-tools/linux-x86/bin/
CLANG_PATH=/home/diamond/prebuilts/clang/host/linux-x86/clang-r487747c/bin/
...
TARGET_DEFCONFIG="gki_defconfig vendor/blair_GKI.config"
...
TARGET_KERNEL_EXT_MODULE_ROOT=$KERNEL_SRC/../sm6375-modules
FIRST_STAGE_MODULES_LIST="modules.list.msm.blair"
